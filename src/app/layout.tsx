        ...
        <header className="sticky top-0 z-50 bg-[--color-charcoal] text-white border-b border-black/10">
          <div className="container flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-semibold">
              ...
              <Link href="#location" className="text-white hover:text-[--color-accent] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[--color-accent] focus-visible:ring-offset-2 focus-visible:ring-offset-[--color-charcoal] rounded-md">Visit</Link>
              <a href="#order" className="btn btn-white text-[--color-brand]">Order Now</a>
            </nav>
            <a href="#order" className="btn btn-white text-[--color-brand] md:hidden" aria-label="Order Now (mobile)">🔥 Order Now</a>
          </div>
        </header>
        {children}
